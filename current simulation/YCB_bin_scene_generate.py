...
p.resetBasePositionAndOrientation(objectID, (-0.01,0.09,0.085), p.getQuaternionFromEuler([np.pi/2,0.,np.pi/2]))
...
mobile_object_IDs.append(objectID)
mobile_object_types.append("cracker_box")
p.resetBasePositionAndOrientation(objectID, (-0.01,-0.085,0.085), p.getQuaternionFromEuler([np.pi/2,0.,np.pi/2]))
...
mobile_object_IDs.append(objectID)
mobile_object_types.append("cracker_box")
p.resetBasePositionAndOrientation(objectID, (-0.01,0.15,0.085), p.getQuaternionFromEuler([np.pi/2,0.,np.pi/2]))
...
mobile_object_IDs.append(objectID)
mobile_object_types.append("cracker_box")
p.resetBasePositionAndOrientation(objectID, (-0.01,-0.145,0.085), p.getQuaternionFromEuler([np.pi/2,0.,np.pi/2]))
...
p.resetBasePositionAndOrientation(objectID, (-0.01,-0.015,0.05), p.getQuaternionFromEuler([0.,0.,np.pi/3 - np.pi/2]))
